<div id="innercontent">
    ...
    <table class="indextable">
        ...
        <tr>
            <td>
                <h3>Forum</h3>
                <a href="<?= forumUrl() ?>"><img src="web/images/icons/chat.png" alt="Forum" /></a><br /><br />
                <a href="<?= forumUrl('board', 13) ?>">Alles zum Forum</a><br />
                <a href="<?= forumUrl('board', 21) ?>">Technischer Support</a><br />
                <a href="<?= forumUrl('board', 15) ?>">Fragen und Antworten</a><br />
                <a href="<?= forumUrl('team') ?>">Jemanden vom Team kontaktieren</a><br />

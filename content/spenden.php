...
<div id="smart-button-container" style="margin: auto;">
  <table style="width: 300px">
    <tr>
      ...
      <td><p id="descriptionError" style="visibility: hidden; color:red; text-align: center;">Please enter a description</p></td>
    </tr>
    <tr>
      <td><label for="amount">Betrag (CHF)</label></td>
      <td><input name="amountInput" type="number" id="amount" value="" ></td>
      <td><p id="priceLabelError" style="visibility: hidden; color:red; text-align: center;">Please enter a price</p></td>
    </tr>
  </table>
  ...
  <script src="https://www.paypal.com/sdk/js?client-id=AQ9pzSF1ZTlq8wSs0XROBpc0rwRArzqonJVOMnaOsZFi6b1eSco0j2OLPVJ1bjny9VJ1cq0pGV9io-nO&enable-funding=venmo&currency=CHF" data-sdk-integration-source="button-factory"></script>
  <script>

...
if (isset($_GET['faq_edit']) && $_GET['faq_edit'] > 0) {
    ...
    if (mysql_num_rows($res) > 0) {
        ...
        if (isset($_POST['faq_edit_submit']) && $_POST['faq_edit_submit'] != "") {
            ...
            dbquery("
                ...
                WHERE domain='faq' AND item_id=" . $_POST['faq_id'] . "
            ;");
            ...
            if ($_POST['send_mail'] == 1) {
                ...
                $headers .= 'From:EtoA Helpcenter<' . get_config('faq_admin') . ">\n";
                $headers .= 'Reply-To:' . get_config('faq_admin') . "\n";
        ...
        if ($arr['faq_user_host'] != "") {
            echo '<tr><th>Host:</th><td>' . $arr['faq_user_host'] . '</td></tr>';
        }
...
elseif (isset($_GET['show']) && $_GET['show'] == "deleted") {
    if (isset($_GET['deldel']) && $_GET['deldel'] > 0) {
        dbquery("
            DELETE FROM
                " . dbtable('faq') . "
		    WHERE
